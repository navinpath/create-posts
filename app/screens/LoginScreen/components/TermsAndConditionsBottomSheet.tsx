  ...
  return (
    <Modalize
      ...
      <View style={styles().content}>
        ...
        <Text style={styles(theme).termsText}>
          create-posts(“we”, “us” or “our”) provides a free and open source
        ...
        <Text style={styles(theme).termsText}>
          As mentioned create-postsis an open source app with it's source code
        ...
        <Text style={styles(theme).termsText}>
          ...
          messenger service. create-postsdoes not control user submitted Content
        ...
        <Text style={styles(theme).subPoints}>
          5) To post or transmit, or cause to be posted or transmitted, any Communication designed or intended to obtain password, account, or private information from any create-postsuser.
        </Text>
        <Text style={styles(theme).subPoints}>
        ...
        <Text style={styles(theme).termsText}>
          ...
          create-postsreserves the right, but has no obligation, to review disputes between
          you and other users. This includes the right to review messages exchanged through
          Proximity’s messenger service, based on any reports that create-postsreceives alleging
